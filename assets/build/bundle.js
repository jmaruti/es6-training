...
var _toastr = __webpack_require__(301);
...
var x1 = function x1(x2) {
  alert(x2);alert('from an anonymous function' + x2);return x2;
};

(0, _jquery2.default)(function () {
  (0, _jquery2.default)('#btn1').on('click', showMsg);
  alert('success');
});

function showMsg() {
  _toastr2.default.warning('this is from the main.js  file');
}
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(115), __webpack_require__(116)(module), __webpack_require__(299)))
...
/* global define */
;(function (define) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(114)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($) {
        return function () {
            var $container;
            var listener;
            var toastId = 0;
